                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                <fieldset>
                                    ...
                                    <div class="control-group <?php if(form_error("category_name")) echo "error"; ?>">
                                        ...
                                        <div class="controls">
                                            <input id="category_name" name="category_name" class="input-xlarge focused" required=""
                                                   placeholder="Enter Category Name" type="text" value="<?php echo
                                            set_value("category_name"); ?>">
                                    ...
                                    <div class="control-group <?php if(form_error("category_description")) echo "error"; ?>">
                                        ...
                                        <div class="controls">
                                            <textarea id="category_description" name="category_description" class="input-xlarge focused"    placeholder="Enter Category Description"  ><?php
