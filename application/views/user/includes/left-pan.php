<div class="navbar-default sidebar" role="navigation">
			...
			<div align="center" class="col-lg-12 center-block user-img"> <img src="<?php echo $this->config->base_url()."public/";?>user/images/user.jpg"></div>
			<h3 class="col-lg-12"><?php echo $USERQUERY[0]->fname." ".$USERQUERY[0]->lname;?></h3>
			<div id="file_upload"><a href="javascript:void(0);"><p class="col-lg-12" style="margin:0; color:#FFFFFF;"><i class="fa fa-edit fa-fw"></i>Edit</p></a><input name="img" type="file" /></div>
