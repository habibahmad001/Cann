...
<thead style='background-color: #ebedf0; color: #565e66; font-family: "Lucida Sans","Lucida Grande","Lucida Sans Unicode",Verdana,sans-serif;'>
  <tr>
    <td colspan="4" align="center"><h1>Course Detail</h1></td>
    </tr>
  </thead>
  <tr>
    <td colspan="2">&nbsp;</td>
...
<thead style='background-color: #ebedf0; color: #565e66; font-family: "Lucida Sans","Lucida Grande","Lucida Sans Unicode",Verdana,sans-serif;'>
  ...
  <?php foreach($QUERY_SECTION as $v) {?>
  <tr>
    <td width="2%">&nbsp;</td>
    <td width="24%"><a href="<?php echo site_url("user/content_view/page_view") . "/" . $v->cscec_id;?>"><?php echo $v->title; ?></a></td>
