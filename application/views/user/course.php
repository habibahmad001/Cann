...
<div id="wrapper">
<img src="<?php echo $this->config->base_url() . "public/";?>images/logo.png" style="float: left;margin: 0 12px 0 0;" /><div style='color: #FFF; font-family: "Arial Black",Gadget,sans-serif; float: left; font-size: 26px; margin: 10px 0 0;'>Cultivate Artists Network</div></div>
<input name="pagename" id="pagename" type="hidden" value="<?php echo site_url("/user/" . $pageName);?>" />
<table width="60%" border="0" class="edit_course" style="float: right; border: 1px solid #FFF; margin: 2% 19% 0px 0px; <?php if(!strpos($_SERVER['REQUEST_URI'], "/Edit/")) echo "display:none;";?>">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" align="center"><h1>Edit Course</h1></td>
    <td style="text-align:right;" align="right" valign="top"><a href="javascript:void(0);" onclick="javascript:closewindow('<?php echo site_url("/user/course"); ?>');">[X]</a></td>
  </tr>
  </thead>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td align="left"><input type="text" name="sumary" id="sumary" value="<?php echo $sumary;?>" /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="60%" border="0" style="float: right; border: 1px solid rgb(204, 204, 204); margin: 4% 19% 0px 0px; margin-bottom:40px;">
  <thead style='background-color: #ebedf0; color: #565e66; font-family: "Lucida Sans","Lucida Grande","Lucida Sans Unicode",Verdana,sans-serif;'>
  <tr>
    <td colspan="4" align="center"><h1>Course Listing</h1></td>
    </tr>
  </thead>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <tr>
      ...
      <td align="center" width="40%"><input type="button" class="btn btn-xs btn-info" name="view" onclick="window.location.href = '<?php echo site_url("user/course_view") . "/view_course/" .$v->course_id; ?>';" id="view" value="View" />
      <input type="button" class="btn btn-xs btn-success" name="section" onclick="window.location.href = '<?php echo site_url("user/section") . "/cid/" .$v->course_id; ?>';" id="section" value="Section" />
      <input type="button" class="btn btn-xs btn-info" name="update" onclick="window.location.href = '<?php echo site_url("user/course") . "/Edit/" .$v->course_id; ?>';" id="update" value="Update" />
      <input name="delete" type="button" class="btn btn-xs btn-danger" onclick="javascript:return confrm('<?php echo $pageName;?>','<?php echo $v->course_id;?>');" value="Delete" /></td>
    </tr>
    <tr>
      <td height="10"></td>
      <td height="10"></td>
