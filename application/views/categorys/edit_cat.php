            ...
            <div class="row-fluid">
                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="muted pull-right"><a class="btn btn-info" href="<?php echo site_url("admin/c_categorys/add_cat"); ?>"><span class="icon-plus"></span>Add Question</a></div>
                    </div>
                                ...
                                <fieldset>
									...
									<div class="control-group <?php if(form_error("parent")) echo "error"; ?>" id="paren-outer">
                                            ...
                                            <div class="controls"  id="paren-inner">
                                                ...
                                                <select name="parent" id="parent" class="input-xlarge focused">
                                                    <option value="-1"> --- Parent --- </option>
                                                    <?php foreach($list_courses as $v) { ?>
                                                    <option value="<?php echo $v["ccid"];?>" <?php if($parent == $v["ccid"]) echo 'selected="selected"';?> > <?php echo $v["title"];?> </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
