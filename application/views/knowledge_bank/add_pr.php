                    ...
                    <div class="block">
                        <div class="navbar navbar-inner block-header">
                            ...
                            <div class="muted pull-right"><a class="btn btn-info" href="<?php echo site_url
                                ("admin/c_problems/add_pr"); ?>"><span class="icon-plus"></span>Add Problems</a></div>
                        </div>
                        <div class="block-content collapse in">
                            <div class="span12">
                                <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                    <fieldset>
                                        <legend>Add Problems</legend>
                                        ...
                                        <div class="control-group <?php if(form_error("qsg_prob_title")) echo "error"; ?>">
                                            ...
                                            <div class="controls">
                                                <input id="qsg_prob_title" name="qsg_prob_title" class="input-xlarge focused" required=""
