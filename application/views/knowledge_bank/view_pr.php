                ...
                <div class="block">
                    <div class="navbar navbar-inner block-header">
                        ...
                        <div class="muted pull-right"><a class="btn btn-info" href="<?php echo site_url
                            ("admin/c_problems/add_pr"); ?>"><span class="icon-plus"></span>Add Problem</a></div>
                    </div>
                        ...
                        <div class="span12">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <?php if(count($view_qa) > 0) foreach($view_qa as $rows): ?>
                                    <tr id="question_id_<?php  echo $rows["qsg_prob_id"]; ?>">
                                    	<td  ><?php  echo $rows["qsg_prob_id"]; ?> </td>
                                        <td  ><?php  echo $rows["qsg_prob_title"]; ?> </td>
                                        <td><?php  echo $rows["report_title"]; ?></td>
                                        <td><?php  echo $rows["threshold_value"]; ?></td>
                                        <td><a href="<?php echo site_url("admin/c_problems/edit_pr");echo "/".$rows["qsg_prob_id"];?>">Edit</a>
                                            <a href="<?php echo site_url("admin/c_problems/del_pr");echo "/".$rows["qsg_prob_id"];?>">Delete</a></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
